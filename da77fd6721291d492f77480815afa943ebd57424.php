...
<link rel="stylesheet" href="<?php echo e(asset('css/css_site/style_accueil.css')); ?>">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <ul>
                    <li><a href="<?php echo e(route('blogs')); ?>"  ><button  type="button" class="btn btn-primary animate__animated animate__backInLeft animate__delay-3s">Demande de devis </button></a></li>
                    <li ><a href="<?php echo e(route('contacts')); ?>"><button type="button" class="btn btn-secondary animate__animated animate__backInLeft animate__delay-2s">Contacter-nous</button></a></li>
                </li>
                </ul>
            </div>
            <div class="col-md-1"></div>
...
<section class="section_accueil_section1">
    <div class="container">
        <div class="row">
            ...
            <img src="<?php echo e(URL::asset('css/image_site/ordinateur_v1.png')); ?>" alt="ordinateur portable" width="100%" height="500">
            </div>
            <div class="col-md-7" data-aos="zoom-in-down" data-aos-offset="450"  data-aos-easing="linear">
                ...
                <a href="<?php echo e(route('about')); ?>"><button class="btn btn-primary">Découvrir notre agence</button></a>
            </div>
        </div>
    </div>
</section>
<section class="section_accueil_service">
    <div class="container">
        <div class="row">
            ...
            <img src="<?php echo e(URL::asset('css/image_site/site-internet.png')); ?>" alt="icon site web" width="45" height="45">
                <h2>Site web</h2>
                ...
                <a href="<?php echo e(route('services')); ?>"><button class="btn btn-primary">En savoir +</button></a>
            </div>
            <div class="col-md-1"></div>
            <div class="col-md-3" data-aos="zoom-in-up" data-aos-easing="linear" data-aos-offset="400">
            <img src="<?php echo e(URL::asset('css/image_site/application-mobile.png')); ?>" alt="icon application web" width="45" height="45">
            ...
            <img src="<?php echo e(URL::asset('css/image_site/app.png')); ?>" alt="icon application desktop" width="45" height="45">
                <h2>App desktop</h2>
    ...
    <div class="container text-center">
        <div class="row">
            ...
            <div class="col-md-3" data-aos="zoom-in-up" data-aos-easing="linear" data-aos-offset="200">
                <img src="<?php echo e(URL::asset('css/image_site/service-clients.png')); ?>" alt="icon accompagnement" width="68" height="37%">
                <p>Accompagnement de A à Z</p>
            </div>
            <div class="col-md-3" data-aos="zoom-in-up" data-aos-easing="linear" data-aos-offset="300">
                <img src="<?php echo e(URL::asset('css/image_site/design-tool.png')); ?>" alt="icon solution" width="68" height="37%">
                <p>Solution sur-mesure</p>
            </div>
            <div class="col-md-3" data-aos="zoom-in-up" data-aos-easing="linear" data-aos-offset="400">
                <img src="<?php echo e(URL::asset('css/image_site/approuve.png')); ?>" alt="icon expertise" width="68" height="37%">
                <p>Expertises maitrisées</p>
            </div>
            <div class="col-md-3" data-aos="zoom-in-up" data-aos-easing="linear" data-aos-offset="500">
            <img src="<?php echo e(URL::asset('css/image_site/24h.png')); ?>" alt="icon 24h/24" width="68" height="37%">
...
<section class="section_accueil_projet">
    <div class="container ">
        <div class="row">
            ...
            <div class="col-md-3" data-aos="zoom-in-up" data-aos-easing="linear" data-aos-offset="300">
                <div class="card">
                    <img src="<?php echo e(URL::asset('css/image_site/bg-projet1.jpg')); ?>" alt="maquete agence asicn" width="100%" height="170">
                    <div class="card-body">
                        <p>Asicn</p>
                        <p class="icon"><img src="<?php echo e(URL::asset('css/image_site/heart-white.png')); ?>" alt="icon coeur" width="17" height="17"> 300</p>
                    </div>
                </div>
            </div>
            <div class="col-md-1"></div>
            <div class="col-md-3">
                <div class="card" data-aos="zoom-in-up" data-aos-easing="linear" data-aos-offset="400">
                    <img src="<?php echo e(URL::asset('css/image_site/bg-projet2.jpg')); ?>" alt="bisso digita logo" width="100%" height="170">
                    <div class="card-body">
                        <p>Association AI HIDN</p>
                        <p class="icon"><img src="<?php echo e(URL::asset('css/image_site/heart-LIKED.png')); ?>" alt="maquete ai hind" width="17" height="17"> 300</p>
                    </div>
                </div>
            </div>
            <div class="col-md-1"></div>
            <div class="col-md-3" data-aos="zoom-in-up" data-aos-easing="linear" data-aos-offset="500">
                <div class="card">
                    <img src="<?php echo e(URL::asset('css/image_site/mak_solace.jpg')); ?>" alt="maquette solace car" width="100%" height="170">
                    <div class="card-body">
                    <p>Solace car</p>
                    <p class="icon"><img src="<?php echo e(URL::asset('css/image_site/heart-white.png')); ?>" alt="bisso digita logo" width="17" height="17"> 256</p>
                    </div>
                </div>
            </div><br>
        </div>
        <div class="row">
            <div class="col-md-12 text-center">
                <a href="<?php echo e(route('blogs')); ?>"><button class="btn btn-primary">Demander un devis</button></a>
            </div>
        </div>
    </div>
</section>
<section class="testimonials">
    ...
    <section class="section_accueil_avi">
        <div class="container">
            ...
            <div class="col-md-6">
            <p><img src="<?php echo e(URL::asset('css/image_site/google.png')); ?>" alt="bisso digita logo" width="22" height="22"> <span>4.9</span> <i class="fa fa-star" style="color:#FFDC0F;" aria-hidden="true"></i>
            <i class="fa fa-star" style="color:#FFDC0F;" aria-hidden="true"></i>
            <i class="fa fa-star" style="color:#FFDC0F;" aria-hidden="true"></i>
            <i class="fa fa-star" style="color:#FFDC0F;" aria-hidden="true"></i>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contenu_site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\agenceweb\resources\views/accueil.blade.php ENDPATH**/ ?>