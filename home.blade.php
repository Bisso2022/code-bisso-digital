...
<head>
    ...
    <link href="{{ asset('css/css_dashbord/style_dashboard.css') }}" rel="stylesheet">
    <link href="{{ asset('css/css_dashbord/style_content.css') }}" rel="stylesheet">
    ...
    <div class="d-flex" id="wrapper">
        <div class="bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading text-center">
                <img src="{{URL::asset('css/image_site/logo (3).png')}}" alt="bisso digital logo" width="100%" height="44">
            </div>
