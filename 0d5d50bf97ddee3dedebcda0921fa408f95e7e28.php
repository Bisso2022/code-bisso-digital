<nav id="navbar_top" class="navbar navbar-expand-lg navbar ">
  <div class="container">
    <a class="navbar-brand" href="/"><img src="<?php echo e(URL::asset('css/image_site/logo (3).png')); ?>" alt="bisso digital logo" width="65%" ></a>
    ...
    <div class="collapse navbar-collapse nav justify-content-center" id="navbarSupportedContent">
      <ul class="navbar-nav " id="navbar-nav ">
        ...
        <li class="nav-item">
          <a class="nav-link" id="l2"  href="<?php echo e(route('about')); ?>">à propos</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="l6"  href="<?php echo e(route('services')); ?>">services</a>
        </li>
        
        <li class="nav-item">
          <a class="nav-link" id="l4"  href="<?php echo e(route('blogs')); ?>">Demande devis</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="l5"  href="<?php echo e(route('contacts')); ?>">Contact</a>
        </li>
      </ul>
    </div>
  </div>
...
<?php /**PATH C:\laragon\www\agenceweb\resources\views/partials/navbar.blade.php ENDPATH**/ ?>