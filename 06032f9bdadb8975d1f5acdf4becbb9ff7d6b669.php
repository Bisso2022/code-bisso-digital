...
<?php $__env->startSection('style_services'); ?>
<link rel="stylesheet" href="<?php echo e(asset('css/css_site/style_services.css')); ?>">
       ...
       <div class="row">
        <div class="col-md-1"></div>
            ...
            <div class="col-md-5" data-aos="zoom-out-up"  data-aos-offset="500"  data-aos-easing="linear">
                <img src="<?php echo e(URL::asset('css/image_site/img_site.png')); ?>" width="100%"  alt="bisso digital logo" >
            </div>
            <div class="col-md-1"></div>
       </div>
    </div>
            ...
            <div class="col-md-4" data-aos="zoom-out-up"  data-aos-offset="300"  data-aos-easing="linear">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('blogs')); ?>" class="btn btn-primary">Demander un devis</a>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5" data-aos="zoom-out-up"  data-aos-offset="400"  data-aos-easing="linear">
                <img src="<?php echo e(URL::asset('css/image_site/im_app_mo.png')); ?>" width="100%"  alt="bisso digital logo" >
            </div>
            <div class="col-md-5" data-aos="zoom-out-up"  data-aos-offset="450"  data-aos-easing="linear">
...
<div class="container">
       <div class="row">
            ...
            <div class="col-md-5" data-aos="zoom-out-up"  data-aos-offset="450"  data-aos-easing="linear">
                <img src="<?php echo e(URL::asset('css/image_site/img_logiciel.png')); ?>" width="100%"  alt="bisso digital logo" >
            </div>
            <div class="col-md-1"></div>
       </div>
    </div>
...
<section class="section_service_projet">
    <div class="container">
        <div class="row">
            <div class="col-md-1"></div>
            <div class="col-md-5" data-aos="zoom-out-up"  data-aos-offset="400"  data-aos-easing="linear">
                <img src="<?php echo e(URL::asset('css/image_site/img_projet.png')); ?>" width="100%"  alt="bisso digital logo" >
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contenu_site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\agenceweb\resources\views/services.blade.php ENDPATH**/ ?>