...
<?php $__env->startSection("style_apropos"); ?>
<link rel="stylesheet" href="<?php echo e(asset('css/css_site/style_apropos.css')); ?>">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6 rigth text-center" >
                ...
                <a href="<?php echo e(route('blogs')); ?>"><button data-aos="zoom-in-down" data-aos-offset="450"  data-aos-easing="linear" class="btn btn-primary">Demande devis</button></a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3" data-aos="zoom-out-up"  data-aos-offset="450"  data-aos-easing="linear">
                <div class="card">
                    <img src="<?php echo e(URL::asset('css/image_site/ardeche.jpg')); ?>" width="100%"  alt="mokoko ardeche photo">
                <div class="card-body" >
            ...
            <div class="col-md-3"  data-aos="zoom-out-up"  data-aos-offset="500"  data-aos-easing="linear">
                <div class="card">
                    <img src="<?php echo e(URL::asset('css/image_site/gaston.png')); ?>" width="100%"  alt="gaston omoua photo">
                <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-3" data-aos="zoom-out-up"  data-aos-offset="300"  data-aos-easing="linear">
                <div class="card">
                        <img src="<?php echo e(URL::asset('css/image_site/mehdi.png')); ?>" width="100%"  alt="mehdi oyome photo">
                    <div class="card-body">
            ...
            <div class="col-md-3" data-aos="zoom-out-up"  data-aos-offset="400"  data-aos-easing="linear">
                <div class="card">
                    <img src="<?php echo e(URL::asset('css/image_site/abdoul.png')); ?>" width="100%"   alt="abdoul karim photo">
                    <div class="card-body">
            ...
            <div class="col-md-3" data-aos="zoom-out-up"  data-aos-offset="500"  data-aos-easing="linear">
                <div class="card">
                    <img src="<?php echo e(URL::asset('css/image_site/gad.jpeg')); ?>" width="100%"    alt="gad obam photo">
                    <div class="card-body">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5" data-aos="zoom-out-up" data-aos-offset="400"  data-aos-easing="linear">
                <img src="<?php echo e(URL::asset('css/image_site/img_teams.png')); ?>" width="100%"  alt="bisso digital logo" >
            </div>
            <div class="col-md-5 text-center" data-aos="zoom-out-up" data-aos-offset="400"  data-aos-easing="linear">
                ...
                <a href="<?php echo e(route('contacts')); ?>"><button class="btn btn-primary">Contacter-nous</button></a>
            </div>
            <div class="col-md-1"></div>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contenu_site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\agenceweb\resources\views/apropos.blade.php ENDPATH**/ ?>